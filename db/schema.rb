...
ActiveRecord::Schema.define(version: 20151226204238) do
  ...
  add_index "subscribes", ["subscribeable_id", "subscribeable_type"], name: "index_subscribes_on_subscribeable_id_and_subscribeable_type", using: :btree
